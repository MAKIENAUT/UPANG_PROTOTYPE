...
function show(n) {
   if (n === 1) {
      console.log(n);
      document.location.href = "../../AdminDisplays/AdminDashboard/Admin_Dashboard.php";
   } else if (n === 2) {
      console.log(n);
      document.location.href = "../../AdminDisplays/AdminResults/Admin_Results.php";
   } else if (n === 3) {
      console.log(n);
      document.location.href = "../../AdminDisplays/AdminVoters/Admin_Voters.php";
   } else if (n === 4) {
      console.log(n);
      document.location.href = "../../AdminDisplays/AdminCandidates/Admin_Candidates.php";
   }
}
